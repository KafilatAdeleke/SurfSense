...
revision = "15_add_zendesk_connector_enum_and_documenttype"
down_revision = "14_add_confluence_connector_enums"
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    op.execute(
        "DELETE FROM search_source_connectors WHERE connector_type = 'ZENDESK_CONNECTOR'"
    )
